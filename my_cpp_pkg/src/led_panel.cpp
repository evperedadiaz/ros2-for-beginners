...
class LedPanelNode : public rclcpp::Node
{
    public:
        LedPanelNode() : Node("led_panel")
        {
            ...
            led_states_publisher_ =
                this->create_publisher<my_robot_interfaces::msg::LedPanelState>("led_states", 10);
            led_states_timer_ =
    ...
    private:
        ...
        rclcpp::Publisher<my_robot_interfaces::msg::LedPanelState>::SharedPtr led_states_publisher_;
